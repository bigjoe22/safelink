...
function buildWidgetComparison(data){
    ...
    javascriptForCalculatingConversion += "var firstValue='USD';var secondValue='BTC';";
    ...
    html+="USD <span class='chevlonarrow' data-toggle='dropdown' ><i class='fa fa-chevron-down'></i></span></button> ";
...
function buildWidget(allItems){
    ...
    html+="<hr class='hr'>";
    html+="<p class='lefttext1 text-center1' style='text-align:center;'>";
    html+="Powered By:";
    html+="<a href='http://bitcoinaverage.com' target='_blank' style='font-weight:bold;'>";
    html+="<img src='https://bitcoinaverage.com/img/logo-bitcoinaverage.png' class='widget_logo1' style='vertical-align: middle'>";
    html+="</a></p></div>";
